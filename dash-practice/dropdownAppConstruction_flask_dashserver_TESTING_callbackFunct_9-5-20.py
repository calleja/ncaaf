...
def init_callbacks(dash_app):
    ...
    @dash_app.callback([Output(component_id='my-output', component_property='children'), Output('dataset','data')], [Input('url', 'href'), Input('week_list', 'value')],[State('dataset','data')])
