...
#candidate object though which to render new plots
    ...
    #json encoder supporting function; converts dates to strings
        ...
        #graphing framework once variables are declared
            ...
            print("encountered an error in graphin portion of first callback. The objects in question are df_opponents of class {}, and dim: {}, df_opponents.index of length {}, opponent1_cd: {} and opponent2_cd: {}".format(str(type(df_opponents)), str(df_opponents.shape), len(df_opponents.index), opponent1_cd, opponent2_cd))
